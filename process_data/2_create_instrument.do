...
==============================================================================*/	
	...
	****************************************************************************
	...
	/*
	CES2.0: 75th percentil score is: 32.66230828250767
...
*/
	...
	drop if instrument==. // tracts never in bandwidht 
...
==============================================================================*/	
	...
	use "`output_data'/cci_ces_versions/cci_CESVersion4.dta"
		x
		...
		// merge with scores 
		merge m:1 CensusTract using "`output_data'/ces4results.dta"
