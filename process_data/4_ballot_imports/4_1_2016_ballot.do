...
==============================================================================*/	
	...
	*/
	...
	save "`output_data'/yearly_ballots/2016_prop_50.dta", replace 
	...
	*/
	...
	import excel "`input_data'/ballot_nov_2016.xls", sheet("Sheet1") firstrow clear
	...
	foreach prop of numlist 51/67 {
		...
		use "`output_data'/yearly_ballots/2016_prop_`prop'.dta", clear
