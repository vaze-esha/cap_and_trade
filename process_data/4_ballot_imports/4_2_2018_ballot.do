...
==============================================================================*/	
	...
	*/
	...
	import excel "`input_data'/ballot_june_2018.xls", sheet("Sheet1") firstrow clear
    ...
    preserve
        ...
        save "`output_data'/yearly_ballots/2018_prop_`prop'.dta", replace
    restore
}
	...
	foreach prop of numlist 68/72 {
		...
		use "`output_data'/yearly_ballots/2018_prop_`prop'.dta", clear
	...
	*/
	...
	import excel "`input_data'/ballot_nov_2018.xls", sheet("Sheet1") firstrow clear
