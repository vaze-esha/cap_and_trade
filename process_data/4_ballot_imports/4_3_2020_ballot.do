...
==============================================================================*/	
	...
	*/
	...
	import excel "`input_data'/ballot_2020.xlsx", sheet("Sheet 1") firstrow clear
    ...
    preserve
        ...
        save "`output_data'/yearly_ballots/2020_prop_`prop'.dta", replace
    restore
}
	...
	foreach prop of numlist 14/25 {
		...
		use "`output_data'/yearly_ballots/2020_prop_`prop'.dta", clear
