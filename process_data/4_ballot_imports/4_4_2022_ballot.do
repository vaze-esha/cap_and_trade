...
==============================================================================*/	
	...
	*/
	...
	import excel "`input_data'/ballot_2022.xlsx", sheet("sheet1") firstrow clear
    ...
    preserve
        ...
        save "`output_data'/yearly_ballots/2022_prop_`prop'.dta", replace
    restore
}
	...
	foreach prop in 1 26 27 28 29 30 31 {
		...
		use "`output_data'/yearly_ballots/2022_prop_`prop'.dta", clear
